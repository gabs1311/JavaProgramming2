...
public class BulkOperations {
    public static void main(String[] args) {
        ...
        boolean r2 = nums.contains(2)&& nums.contains(5) && nums.contains(8);
      ...
      /*  ArrayList<String >namesList = new ArrayList<>();
        namesList.addAll(Arrays.asList(names));// this is how I can convert primitive Array
       // into an ArrayList*/
        ArrayList<String >namesList = new ArrayList<>(Arrays.asList(names)); // converting a
        // primitive Array into an array List
