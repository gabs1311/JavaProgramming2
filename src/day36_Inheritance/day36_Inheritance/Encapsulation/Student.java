package day36_Inheritance.day36_Inheritance.Encapsulation;
...
1. Create a class named Student:
			...
			Encapsulate all the fileds (at least encapsulate two fields manually)
					requirments:
						...
						2. gender should not be set to any chanarcter other
						than: 'M' and 'F'
						3. grade should not be set to any chanacters other
						than: 'A', 'B', 'C', 'D', and 'F'
