...
public class IteratingTheMap {
    ...
    /*    for (String eachKey : keys) {
      ...
      */
        ...
        for (String key : students.keySet()) {      // I apply for each loop to get the key
      ...
      /* // this is one way to solve it- the best
        ...
        */
        // another way, using keys, but the other one is  better, because if has one less step
