...
public class SalaryCalculator {
    public static void main(String[] args) {
        ...
        int hourlyRate = 50,// It the next variable is the same type, I don't have to use
                            // the type again, but use , instead of ; after the first line
         weeklyHours = 45;
        double stateTaxRate = 6.5,
                federalTaxRate = 26.2;// If I need to convert the percentage of 25.2 into decimals
                                    //I have to divide it by 100
        //------------------------------
